                ...
                @foreach ($data as $d)
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="p-2">
                            ...
                            <input type="text" name="name"value="{{ $d->name }}" style="color:black;"
                                placeholder="Write the name">
                        </div>
                        <div class="p-2">
                            <label>phone:</label>
                            <input type="number" name="phone" value="{{ $d->phone }}" style="color:black;"
                        ...
                        <div class="p-2">
                            ...
                            <input type="number" name="room" value="{{ $d->room }}" style="color:black;"
