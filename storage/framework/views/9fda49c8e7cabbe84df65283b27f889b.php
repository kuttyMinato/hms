      ...
      <form class="main-form" action="<?php echo e(url('/appointment')); ?>" method="POST" >
        ...
        <div class="row mt-5 ">
          ...
          <div class="col-12 col-sm-6 py-2 wow fadeInRight" data-wow-delay="300ms">
            <select  name="doctor" id="name" class="custom-select">
              ...
              <option value="<?php echo e($doctors->name); ?>"><?php echo e($doctors->name); ?> (<?php echo e($doctors->speciality); ?> specialist)</option>
...
<?php /**PATH D:\hms\resources\views/user/appointment.blade.php ENDPATH**/ ?>